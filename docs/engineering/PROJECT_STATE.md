...
- **B2-D1** (application provisioning): PARTIAL, founder-accepted, on repository/TEST (route-level check PASS 40/40; browser E2E BLOCKED); uncommitted, not deployed (needs B2-B production first).
